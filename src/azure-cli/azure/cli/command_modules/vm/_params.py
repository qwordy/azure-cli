...
def load_arguments(self, _):
    ...
    with self.argument_context('disk') as c:
        ...
        c.argument('tier', path='tier', help='Performance tier of the disk (e.g, P4, S10) as described here: https://azure.microsoft.com/en-us/pricing/details/managed-disks/. Does not apply to Ultra disks.')
    # endregion
    ...
    with self.argument_context('vm update') as c:
        ...
        # c.argument('os_caching', help='OS disk caching')
